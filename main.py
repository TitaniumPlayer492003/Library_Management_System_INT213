...
class main:
    def login(self):
        ...
        if self.ab != None:
            ...
            self.ig = PhotoImage(
                file=r"library_management_files\visual_assets\library.png"
            )
    ...
    def cur(self):
        ...
        self.photo9 = PhotoImage(
            file=r"library_management_files\visual_assets\afterlogin1.png"
        )
        ...
        try:
            ...
            self.log8 = PhotoImage(
                file=r"library_management_files\visual_assets\bt8.png"
            )
        ...
        class retu(main):
            ...
            def retbook(self):
                ...
                if self.data != None:
                    ...
                    messagebox.showerror(
                        "Invalid REG ID", "This student doesn't exist!"
                    )
                    self.entry4.delete(0, END)
    ...
    def code(self):
        ...
        self.photo = PhotoImage(
            file=r"library_management_files\visual_assets\summer-reading-program.png"
        )
